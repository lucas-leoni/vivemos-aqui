<template>
  <span>
    <b>
      <i>
        “É obrigação da União fazer a proteção da população indígena”, frase de
        Cynthia
      </i>
    </b>
    <br />
    ...
    <br />
    <br />
    Organizações internacionais e de proteção aos direitos humanos têm apontado
    para um retrocesso à proteção dos povos indígenas no Brasil. Recentemente,
    segundo o jornalista Jamil Chade, o governo
    <a
    ...
    >
    da Organização das Nações Unidas (ONU) para a defesa dos indígenas. Mesmo na
    época aceitando, o governo não cumpriu nenhuma delas, conforme a avaliação
    de mais de cem entidades de organizações indígenas, indigenistas,
    ...
    58,4 hectares foram destruídos e em 2021, 2.409 hectares — um crescimento de
    41 vezes.
    <br />
    <br />
